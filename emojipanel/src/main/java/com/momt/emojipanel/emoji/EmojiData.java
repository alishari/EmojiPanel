...
/*
Some changes applied to remove redundancy and Improving performance.
 */
...
public class EmojiData {
    ...
    private static final String[] aliasOld = new String[]{
            "👱", "👱🏻", "👱🏼", "👱🏽", "👱🏾", "👱🏿",
            "👳", "👳🏻", "👳🏼", "👳🏽", "👳🏾", "👳🏿",
            "👷", "👷🏻", "👷🏼", "👷🏽", "👷🏾", "👷🏿",
            "👮", "👮🏻", "👮🏼", "👮🏽", "👮🏾", "👮🏿",
    ...
    private static final String[] aliasNew = new String[]{
            "👱‍♂", "👱🏻‍♂", "👱🏼‍♂", "👱🏽‍♂", "👱🏾‍♂", "👱🏿‍♂",
            "👳‍♂", "👳🏻‍♂", "👳🏼‍♂", "👳🏽‍♂", "👳🏾‍♂", "👳🏿‍♂",
            "👷‍♂", "👷🏻‍♂", "👷🏼‍♂", "👷🏽‍♂", "👷🏾‍♂", "👷🏿‍♂",
            "👮‍♂", "👮🏻‍♂", "👮🏼‍♂", "👮🏽‍♂", "👮🏾‍♂", "👮🏿‍♂",
    ...
    static final HashSet<Character> dataCharsMap = new HashSet<>(Arrays.asList(new Character[]{
    ...
    public static final HashSet<String> emojiColoredMap = new HashSet<>(Arrays.asList("🤲", "👐", "🙌", "👏", "👍", "👎", "👊", "✊", "🤛", "🤜", "🤞", "✌", "🤟", "🤘", "👌", "👈", "👉", "👆", "👇", "☝", "✋", "🤚", "🖐", "🖖", "👋", "🤙", "💪", "🖕", "✍", "🙏", "🦶", "🦵", "👂", "👃", "👶", "👧", "🧒", "👦", "👩", "🧑", "👨", "👩‍🦱", "👨‍🦱", "👩‍🦰", "👨‍🦰", "👱‍♀", "👱‍♂", "👩‍🦳", "👨‍🦳", "👩‍🦲", "👨‍🦲", "🧔", "👵", "🧓", "👴", "👲", "👳‍♀", "👳‍♂", "🧕", "👮‍♀", "👮‍♂", "👷‍♀", "👷‍♂", "💂‍♀", "💂‍♂", "🕵‍♀", "🕵‍♂", "👩‍⚕", "👨‍⚕", "👩‍🌾", "👨‍🌾", "👩‍🍳", "👨‍🍳", "👩‍🎓", "👨‍🎓", "👩‍🎤", "👨‍🎤", "👩‍🏫", "👨‍🏫", "👩‍🏭", "👨‍🏭", "👩‍💻", "👨‍💻", "👩‍💼", "👨‍💼", "👩‍🔧", "👨‍🔧", "👩‍🔬", "👨‍🔬", "👩‍🎨", "👨‍🎨", "👩‍🚒", "👨‍🚒", "👩‍✈", "👨‍✈", "👩‍🚀", "👨‍🚀", "👩‍⚖", "👨‍⚖", "👰", "🤵", "👸", "🤴", "🦸‍♀", "🦸‍♂", "🦹‍♀", "🦹‍♂", "🤶", "🎅", "🧙‍♀", "🧙‍♂", "🧝‍♀", "🧝‍♂", "🧛‍♀", "🧛‍♂", "🧜‍♀", "🧜‍♂", "🧚‍♀", "🧚‍♂", "👼", "🤰", "🤱", "🙇‍♀", "🙇‍♂", "💁‍♀", "💁‍♂", "🙅‍♀", "🙅‍♂", "🙆‍♀", "🙆‍♂", "🙋‍♀", "🙋‍♂", "🤦‍♀", "🤦‍♂", "🤷‍♀", "🤷‍♂", "🙎‍♀", "🙎‍♂", "🙍‍♀", "🙍‍♂", "💇‍♀", "💇‍♂", "💆‍♀", "💆‍♂", "🧖‍♀", "🧖‍♂", "💅", "🤳", "💃", "🕺", "🕴", "🚶‍♀", "🚶‍♂", "🏃‍♀", "🏃‍♂", "🏋‍♀", "🏋‍♂", "🤸‍♀", "🤸‍♂", "⛹‍♀", "⛹‍♂", "🤺", "🤾‍♀", "🤾‍♂", "🏌‍♀", "🏌‍♂", "🏇", "🧘‍♀", "🧘‍♂", "🏄‍♀", "🏄‍♂", "🏊‍♀", "🏊‍♂", "🤽‍♀", "🤽‍♂", "🚣‍♀", "🚣‍♂", "🧗‍♀", "🧗‍♂", "🚵‍♀", "🚵‍♂", "🚴‍♀", "🚴‍♂", "🤹‍♀", "🤹‍♂", "🛀"));

    static final HashMap<CharSequence, CharSequence> emojiAliasMap = new HashMap<>(aliasNew.length);
